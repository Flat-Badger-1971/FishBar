...
--- @param endRollRadians number
--- @return void
function AnimationObject3DRotate:SetRotationValues(startPitchRadians, startYawRadians, startRollRadians, endPitchRadians,
                                                   endYawRadians, endRollRadians) end
...
--- @param endZRadians number
--- @return void
function AnimationObjectTransformRotation:SetRotations(startXRadians, startYRadians, startZRadians, endXRadians,
                                                       endYRadians, endZRadians) end
...
--- @return void
function CompassDisplayControl:SetAlphaDropoffBehavior(pinType, closeAlpha, farAlpha, closeAlphaDistanceM,
                                                       farAlphaDistanceM) end
...
--- @return void
function CompassDisplayControl:SetPinInfo(pinType, pinSize, pinTexture, areaTexture, aboveTexture, belowTexture,
                                          linkTexture, clamped, allowUpdatesWhenAnimating, maxDistanceM, closeScale,
                                          farScale, closeScaleDistanceM, farScaleDistanceM, closeAlpha, farAlpha,
                                          closeAlphaDistanceM, farAlphaDistanceM, animation, addedAnimation,
                                          removedAnimation, layer, drawLevelOffsetBase) end
...
--- @param farScaleDistanceM number
--- @return void
function CompassDisplayControl:SetScaleDropoffBehavior(pinType, closeScale, farScale, closeScaleDistanceM,
                                                       farScaleDistanceM) end
...
--- @return void
function Control:SetMotionBlur(blurVectorXAsAPercentageOfControlWidth, blurVectorYAsAPercentageOfControlHeight,
                               numSamples) end
...
--- @return void
function MapDisplayControl:SetBasePinData(pinType, arrowType, pinSize, pinXInset, pinYInset, arrowSize, textureFilename,
                                          arrowTextureFilename, areaTextureFilename, aboveTextureFilename,
                                          belowTextureFilename, linkTextureFilename, animation, addedAnimation,
...
--- @return void
function PolygonControl:SetBorder(minThickness, maxThickness, thicknessPercent, color, textureFile, desaturation,
                                  blendMode, direction) end
...
--- @return void
function SliderControl:SetThumbTexture(filename, disabledFilename, highlightedFilename, thumbWidth, thumbHeight, texTop,
                                       texLeft, texBottom, texRight) end
...
--- @param flush boolean
--- @return void
function SliderControl:SetThumbTextureAndFlush(filename, disabledFilename, highlightedFilename, thumbWidth, thumbHeight,
                                               texTop, texLeft, texBottom, texRight, flush) end
...
--- @return void
function TextureCompositeControl:SetSurfaceTextureRotation(surfaceIndex, angleInRadians, normalizedRotationPointX,
                                                           normalizedRotationPointY) end
...
--- @return void
function TooltipControl:SetActiveSkill(skillType, skillLineIndex, skillIndex, morphSlot, isPurchased, isAdvised,
                                       isBadMorph, numAvailableSkillPoints, showSkillPointCost, showUpgradeText,
                                       showAdvised, showBadMorph, overrideRank, overrideAbilityId) end
...
--- @return void
function TooltipControl:SetCraftedAbility(craftedAbilityId, primaryScriptId, secondaryScriptId, tertiaryScriptId,
                                          displayFlags) end
...
--- @param displayFlags ScribingTooltipDisplayFlags
--- @return void
function TooltipControl:SetCraftedAbilityScript(craftedAbilityId, craftedAbilityScriptId, primaryScriptId,
                                                secondaryScriptId, tertiaryScriptId, displayFlags) end
...
--- @param showSkillPointCost boolean
--- @return void
function TooltipControl:SetPassiveSkill(skillType, skillLineIndex, skillIndex, rank, purchasedToRank,
                                        numAvailableSkillPoints, showSkillPointCost) end
...
--- @return void
function TooltipControl:SetPendingAlchemyItem(solventBagId, solventSlotIndex, reagent1BagId, reagent1SlotIndex,
...
--- @return void
function TooltipControl:SetPendingEnchantingItem(potencyRuneBagId, potencyRuneSlotIndex, essenceRuneBagId,
...
--- @return void
function TooltipControl:SetTributePatron(patronId, highlightActiveFavorState, suppressNotCollectibleWarning,
                                         showAcquireHint, showLore) end
