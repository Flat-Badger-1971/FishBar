...
--- @return void
function SendLeaderToFollowerSync(messageOrigin, syncType, currentSceneName, nextSceneName, sequenceNumber,
...
--- @param modifier4 KeyCode
--- @return void
function BindKeyToAction(layerIndex, categoryIndex, actionIndex, bindingIndex, key, modifier1, modifier2, modifier3,
                         modifier4) end                                                                                             --*protected*
...
function StartMapPinAnimation(animationTimeline, animationTarget, limitToMapType, pinType, param1, param2, param3,
                              playOffset, ignoreBreadcrumbs) end
...
function GetMaxIterationsPossibleForAlchemyItem(solventBagId, solventSlotIndex, reagent1BagId, reagent1SlotIndex,
                                                reagent2BagId, reagent2SlotIndex, reagent3BagId, reagent3SlotIndex) end
...
--- @param numIterations integer
--- @return void
function CraftAlchemyItem(solventBagId, solventSlotIndex, reagent1BagId, reagent1SlotIndex, reagent2BagId,
                          reagent2SlotIndex, reagent3BagId, reagent3SlotIndex, numIterations) end
...
function GetAlchemyResultingItemInfo(solventBagId, solventSlotIndex, reagent1BagId, reagent1SlotIndex, reagent2BagId,
                                     reagent2SlotIndex, reagent3BagId, reagent3SlotIndex) end
...
function GetAlchemyResultingItemLink(solventBagId, solventSlotIndex, reagent1BagId, reagent1SlotIndex, reagent2BagId,
                                     reagent2SlotIndex, reagent3BagId, reagent3SlotIndex, linkStyle) end
...
function GetAlchemyResultInspiration(solventBagId, solventSlotIndex, reagent1BagId, reagent1SlotIndex, reagent2BagId,
                                     reagent2SlotIndex, reagent3BagId, reagent3SlotIndex) end
...
function GetAlchemyResultingItemIdIfKnown(solventBagId, solventSlotIndex, reagent1BagId, reagent1SlotIndex, reagent2BagId,
                                          reagent2SlotIndex, reagent3BagId, reagent3SlotIndex, desiredEncodedTraits) end
...
--- @param numIterations integer
--- @return integer cost
function GetCostToCraftEnchantingItem(potencyRuneBagId, potencyRuneSlotIndex, essenceRuneBagId, essenceRuneSlotIndex,
                                      aspectRuneBagId, aspectRuneSlotIndex, numIterations) end
...
--- @param aspectRuneSlotIndex integer
--- @return integer numIterations, TradeskillResult limitReason
function GetMaxIterationsPossibleForEnchantingItem(potencyRuneBagId, potencyRuneSlotIndex, essenceRuneBagId,
                                                   essenceRuneSlotIndex, aspectRuneBagId, aspectRuneSlotIndex) end
...
--- @param numIterations integer
--- @return void
function CraftEnchantingItem(potencyRuneBagId, potencyRuneSlotIndex, essenceRuneBagId, essenceRuneSlotIndex,
                             aspectRuneBagId, aspectRuneSlotIndex, numIterations) end
...
function GetEnchantingResultingItemInfo(potencyRuneBagId, potencyRuneSlotIndex, essenceRuneBagId, essenceRuneSlotIndex,
                                        aspectRuneBagId, aspectRuneSlotIndex) end
...
--- @param linkStyle LinkStyle
--- @return string link
function GetEnchantingResultingItemLink(potencyRuneBagId, potencyRuneSlotIndex, essenceRuneBagId, essenceRuneSlotIndex,
                                        aspectRuneBagId, aspectRuneSlotIndex, linkStyle) end
...
--- @param aspectRuneSlotIndex integer
--- @return boolean isKnown
function AreAllEnchantingRunesKnown(potencyRuneBagId, potencyRuneSlotIndex, essenceRuneBagId, essenceRuneSlotIndex,
                                    aspectRuneBagId, aspectRuneSlotIndex) end
...
function IsCraftedAbilityScriptCompatibleWithSelections(checkScriptId, craftedAbilityId, selectedPrimaryScriptId,
                                                        selectedSecondaryScriptId, selectedTertiaryScriptId) end
...
function IsScribableScriptCombinationForCraftedAbility(craftedAbilityId, selectedPrimaryScriptId,
                                                       selectedSecondaryScriptId, selectedTertiaryScriptId) end
...
--- @param numIterations integer
--- @return integer cost
function GetCostToCraftSmithingItem(patternIndex, materialIndex, materialQuantity, itemStyleId, traitIndex,
                                    useUniversalStyleItem, numIterations) end
...
--- @param useUniversalStyleItem boolean
--- @return integer numIterations, TradeskillResult limitReason
function GetMaxIterationsPossibleForSmithingItem(patternIndex, materialIndex, materialQuantity, itemStyleId, traitIndex,
                                                 useUniversalStyleItem) end
...
--- @param numIterations integer
--- @return void
function CraftSmithingItem(patternIndex, materialIndex, materialQuantity, itemStyleId, traitIndex, useUniversalStyleItem,
                           numIterations) end
...
function GetSmithingPatternInfo(patternIndex, materialIndexOverride, materialQuanityOverride, styleOverride,
                                traitTypeOverride) end
...
--- @return void
function SendOutfitChangeRequest(useFlatCurrency, actorCategory, outfitIndex, outfitSlot, collectibleId,
                                 itemMaterialIndex, primaryDyeId, secondaryDyeId, accentDyeId) end
...
--- @return void
function SetPendingHeraldryIndices(backgroundCategoryIndex, backgroundStyleIndex, backgroundPrimaryColorIndex,
                                   backgroundSecondaryColorIndex, crestCategoryIndex, crestStyleIndex, crestColorIndex) end
...
--- @return void
function SetSCTSlotPosition(slotIndex, SCTAnchorType, anchorPoint, UIOffsetX, UIOffsetY, cameraOffsetRight,
                            cameraOffsetUp) end
...
--- @param rollRadians number
--- @return HousingRequestResult result
function HousingEditorRequestItemPlacement(bagId, slotIndex, worldX, worldY, worldZ, pitchRadians, yawRadians,
                                           rollRadians) end
...
--- @param rollRadians number
--- @return HousingRequestResult result
function HousingEditorRequestCollectiblePlacement(collectibleId, worldX, worldY, worldZ, pitchRadians, yawRadians,
                                                  rollRadians) end
...
--- @param rollRadians number
--- @return HousingRequestResult result
function HousingEditorRequestChangePositionAndOrientation(furnitureId, worldX, worldY, worldZ, pitchRadians, yawRadians,
                                                          rollRadians) end
...
--- @return number pitchRadians, number yawRadians, number rollRadians
function HousingEditorCalculateRotationAboutAxis(aAxis, aOffsetRadians, aInitialPitchRadians, aInitialYawRadians,
                                                 aInitialRollRadians) end
...
function HousingEditorGetScreenPointWorldPlaneIntersection(aScreenX, aScreenY, aWorldX1, aWorldY1, aWorldZ1, aWorldX2,
                                                           aWorldY2, aWorldZ2, aWorldX3, aWorldY3, aWorldZ3) end
...
--- @return HousingRequestResult result
function HousingEditorRequestInsertPathNode(furnitureId, index, worldX, worldY, worldZ, headingRadians, speed,
                                            reachDestinationDelayTime) end
...
--- @param reachDestinationDelayTime integer
--- @return HousingRequestResult result
function HousingEditorRequestModifyPathNode(furnitureId, index, worldX, worldY, worldZ, headingRadians, speed,
                                            reachDestinationDelayTime) end
...
--- @param campaignKey id64
--- @return integer numActivitiesCompleted, boolean isCapstoneRewardClaimed
...
--- @param campaignKey id64
--- @param activityIndex luaindex
--- @return integer progress, boolean isRewardClaimed
...
--- @param campaignKey id64
--- @param milestoneIndex luaindex
--- @return boolean isRewardClaimed
function IsPromotionalEventCampaignMilestoneRewardClaimed(campaignKey, milestoneIndex) end
...
function CanItemTakeEnchantment(itemToEnchantBagId, itemToEnchantSlotIndex, enchantmentToUseBagId,
                                enchantmentToUseSlotIndex) end
...
function GetAmountSoulGemWouldChargeItem(itemToChargeBagId, itemToChargeSlotIndex, soulGemToConsumeBagId,
                                         soulGemToConsumeSlotIndex) end
...
function GetAmountRepairKitWouldRepairItem(itemToRepairBagId, itemToRepairSlotIndex, repairKitToConsumeBagId,
                                           repairKitToConsumeSlotIndex) end
...
--- @param repairKitToConsumeSlotIndex integer
--- @return void
function RepairItemWithRepairKit(itemToRepairBagId, itemToRepairSlotIndex, repairKitToConsumeBagId,
                                 repairKitToConsumeSlotIndex) end
...
--- @param filterTypes integer
--- @return boolean containsProducts
function DoesMarketProductCategoryOrSubcategoriesContainFilteredProducts(displayGroup, topLevelIndex, categoryIndex,
                                                                         filterTypes) end
...
--- @param worldZ number
--- @return integer|nil particleEffectId
function CreateCrownCrateTierSpecificParticleEffect(crownCrateTierId, crownCrateTierParticleEffects, worldX, worldY,
                                                    worldZ) end                                                                  --*private*
...
--- @return void
function AddOutfitSlotPreviewElementToPreviewCollection(outfitSlot, collectibleDefId, itemMaterialIndex, primaryDyeDefId,
                                                        secondaryDyeDefId, accentDyeDefId) end                                                                   --*private*
...
--- @return void
function PreviewCraftItem(patternIndex, materialIndex, materialQuantity, styleIndex, traitIndex, useUniversalStyleItem,
                          dyeBrushId) end
...
--- @param targetingFormatterOverrideText string
--- @return string targetingText
function GetTributePatronRequirementTargetingText(requirementType, quantity, param1, param2,
                                                  targetingFormatterOverrideText) end
